...
class PROPOSED3(nn.Module):
    ...
    def loss(self, user_indices, item_seq_indices, pos_item_indices, neg_item_indices):
        ...
        mip_loss = torch.cat((mip_loss, self.sampled_ce_loss(mip_score)),0)
        ...
        return amip_l1_loss.mean(), amip_l2_loss.mean(), amip_r1_loss.mean(), amip_r2_loss.mean(), mip_loss.mean()